        ...
        <div className="hero-container">
          <div className="hero-content">
            ...
            <div className="hero-buttons">
              <a href="https://order.minddumper.com" className="btn-primary">Clear My Mind Now - €49</a>
            </div>
        ...
        <div className="section-container">
          ...
          <div className="pricing-single">
            <div className="pricing-card featured single">
              ...
              <a href="https://order.minddumper.com" className="btn-primary">Get Lifetime Access - €49</a>
