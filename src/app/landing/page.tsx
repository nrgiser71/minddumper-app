      ...
      <nav className="navbar">
        <div className="nav-container">
          ...
          <div className="nav-menu">
            ...
            <a href="https://checkout.minddumper.com/checkout/minddumper" className="nav-cta">Get Started - €49</a>
          </div>
        </div>
      </nav>
        ...
        <div className="hero-container">
          <div className="hero-content">
            ...
            <div className="hero-buttons">
              <a href="https://checkout.minddumper.com/checkout/minddumper" className="btn-primary">Clear My Mind Now - €49</a>
            </div>
        ...
        <div className="section-container">
          ...
          <div className="pricing-single">
            <div className="pricing-card featured single">
              ...
              <a href="https://checkout.minddumper.com/checkout/minddumper" className="btn-primary">Get Lifetime Access - €49</a>
